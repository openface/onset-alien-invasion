<template>
    <div id="container">
        <div id="inner">
            ...
            <div class="info">
                You are now being deployed onto a deserted island that has been
                overrun with alien beings.
                <b
                    >Find the safe zone until you discover further
                    instructions!</b
                >
                We will send more information via a computer terminal located in
                the garage of an abandoned house. Stay alive and thanks for
                testing this gamemode!
            </div>
