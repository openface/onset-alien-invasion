...
AddRemoteEvent("LoadStorageData", function(data)
  ...
  --ExecuteWebJS(StorageUI, "EmitEvent('LoadStorageData',"..data..")")

  local x,y,z = GetPlayerLocation(GetPlayerId())
  storage_timer = CreateTimer(OpenStorageTimer, 1000, { x = x, y = y, z = z })
end)
...
AddRemoteEvent("SetInventory", function(data)
    ExecuteWebJS(StorageUI, "EmitEvent('SetInventory'," .. data .. ")")
end)
